...
const TOUR_STEPS = [
  ...
  {
    title: "מדריך הלכתי 📖",
    text: "לחצי כאן למדריך ההלכתי שמאחורי החישובים — מצות הפרישה, חישוב הוסתות, עקירתן, הפסק טהרה ושבעה נקיים.\n\nהמדריך נועד להבהרה כללית בלבד, ואינו בא במקום שאלת רב.",
    target: "#guide-link",
  },
  {
    title: "הסיור הסתיים! ✨",
